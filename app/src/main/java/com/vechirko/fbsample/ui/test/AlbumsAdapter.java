...
public class AlbumsAdapter extends RecyclerView.Adapter<AlbumsAdapter.AlbumHolder> {
    ...
    List<AlbumContract> data = new ArrayList<>();
    ...
    public void onBindViewHolder(AlbumHolder holder, int position) {
        AlbumContract album = data.get(position);
    ...
    private void openAlbum(Context c, AlbumContract album) {
//        c.startActivity(PostActivity.newIntent(c, album.getId()));
    }

    public void setData(Collection<AlbumContract> list) {
